...
def draw_gratr
  ...
  nameDepthPixelBarrel = [
    {:name => :"pixbarladderfull0:PixelBarrelLadderFull0", :depth => 1},
    {:name => :"pixbarladderfull1:PixelBarrelLadderFull1", :depth => 1},
    {:name => :"pixbarladderfull2:PixelBarrelLadderFull2", :depth => 1},
    {:name => :"pixbarladderfull3:PixelBarrelLadderFull3", :depth => 1},
  ]

  nameDepthPixelForward = [
    {:name => :"pixfwdbladeInnerZplus:PixelForwardBlade", :depth => 1},
    {:name => :"pixfwdbladeOuterZplus:PixelForwardBlade", :depth => 1},
    {:name => :"pixfwdbladeInnerZminus:PixelForwardBlade", :depth => 1},
    {:name => :"pixfwdbladeOuterZminus:PixelForwardBlade", :depth => 1},
  ]

  nameDepthTIB = [
    {:name => :"tiblayer0:TIBLayer0Up", :depth => 2},
  ...
  nameDepthTID = [
    {:name => :"tidmodule0r:TIDModule0R", :depth => 0},
  ...
  nameDepthEE = [
    {:name => :"eregalgo:EESCEnv1", :depth => 0},
