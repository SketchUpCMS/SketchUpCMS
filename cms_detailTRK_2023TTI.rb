...
def draw_gratr
  ...
  nameDepthPixelBarrel = [ {:name => :"pixbarladderfull0:PixelBarrelLadderFull0", :depth => 1},
                           {:name => :"pixbarladderfull1:PixelBarrelLadderFull1", :depth => 1},
                           {:name => :"pixbarladderfull2:PixelBarrelLadderFull2", :depth => 0},
                           {:name => :"pixbarladderfull3:PixelBarrelLadderFull3", :depth => 0},
  ...
  nameDepthPixelForward = [ {:name => :"pixfwdDisks:PixelForwardDisk1", :depth => 1},
                            {:name => :"pixfwdDisks:PixelForwardDisk2", :depth => 1},
                            {:name => :"pixfwdDisks:PixelForwardDisk3", :depth => 1},
                            {:name => :"pixfwdDisks:PixelForwardDisk4", :depth => 1},
                            {:name => :"pixfwdDisks:PixelForwardDisk5", :depth => 1},
                            {:name => :"pixfwdDisks:PixelForwardDisk6", :depth => 1},
                            {:name => :"pixfwdDisks:PixelForwardDisk7", :depth => 1},
                            {:name => :"pixfwdDisks:PixelForwardDisk8", :depth => 1},
                            {:name => :"pixfwdDisks:PixelForwardDisk9", :depth => 1},
                            {:name => :"pixfwdDisks:PixelForwardDisk10", :depth => 1},
                            {:name => :"tracker:Disc6", :depth => 2},
                            {:name => :"tracker:Disc7", :depth => 2},
                            {:name => :"tracker:Disc8", :depth => 2},
                            {:name => :"tracker:Disc9", :depth => 2},
                            {:name => :"tracker:Disc10", :depth => 2},
                          ]
