...
class SolidsManager
  ...
  KnownPartNames = [:PseudoTrap, :Trd1, :Polycone, :Polyhedra, :Trapezoid, :Tubs, :Box, :Cone, :Torus, :UnionSolid, :SubtractionSolid, :ExtrudedPolygon, :TruncTubs, :IntersectionSolid]
